...
#   - AGENT_MNEMONIC (or ISSUER_WEB_VS_AGENT_MNEMONIC) — this service's own agent account
#
# Usage:
#   source issuer-web-vs/config.env
#   MNEMONIC="..." AGENT_MNEMONIC="..." ./issuer-web-vs/scripts/setup.sh
#
# =============================================================================
...
AGENT_MNEMONIC="${AGENT_MNEMONIC:-${ISSUER_WEB_VS_AGENT_MNEMONIC:-}}"
...
docker run --platform linux/amd64 -d \
  ...
  -e "EVENTS_WEBHOOK_URL=http://host.docker.internal:${ISSUER_WEB_PORT}/events" \
